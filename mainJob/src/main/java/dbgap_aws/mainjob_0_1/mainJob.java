...
import routines.paramsRetriever;
import routines.TalendString;
import routines.StringHandling;
import routines.Relational;
import routines.TalendDate;
import routines.fileWriter;
 ...
 * @version 7.2.1.20190228_1114-M3
 * @status 
 */
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(configFilePath != null){
					...
					this.setProperty("configFilePath", configFilePath.toString());
				
			}
			
			if(dataOutputPath != null){
				
					this.setProperty("dataOutputPath", dataOutputPath.toString());
				
			}
			
			if(dataSourcePath != null){
				
					this.setProperty("dataSourcePath", dataSourcePath.toString());
				
			}
			
			if(dictOutputPath != null){
				
					this.setProperty("dictOutputPath", dictOutputPath.toString());
				
			}
			
			if(dictSourcePath != null){
				
					this.setProperty("dictSourcePath", dictSourcePath.toString());
			...
			if(fileNameSubject != null){
					...
					this.setProperty("fileNameSubject", fileNameSubject.toString());
			...
			if(studyId != null){
					...
					this.setProperty("studyId", studyId.toString());
				
			}
			
			if(studyName != null){
				
					this.setProperty("studyName", studyName.toString());
				
			}
			
			if(subjectTableId != null){
				
					this.setProperty("subjectTableId", subjectTableId.toString());
...
public String dictOutputPath;
public String getDictOutputPath(){
	return this.dictOutputPath;
}
...
public String getConsentVarName(){
	return this.consentVarName;
}
public String fileNameSubject;
...
public Boolean getSubset(){
	...
	private final String projectName = "DBGAP_AWS";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(mainJob.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_DBGAP_AWS_mainJob = new byte[0];
    static byte[] commonByteArray_DBGAP_AWS_mainJob = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_DBGAP_AWS_mainJob.length) {
				if(length < 1024 && commonByteArray_DBGAP_AWS_mainJob.length == 0) {
   					commonByteArray_DBGAP_AWS_mainJob = new byte[1024];
				} else {
   					commonByteArray_DBGAP_AWS_mainJob = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_DBGAP_AWS_mainJob, 0, length);
			strReturn = new String(commonByteArray_DBGAP_AWS_mainJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_DBGAP_AWS_mainJob) {
 ...
 */
	...
	try{//}
		fid_tFileInputFullRow_1 =new org.talend.fileprocess.FileInputDelimited(context.configFilePath,"ISO-8859-15","","\n",true,0,0,-1,-1,false);
 ...
 */
    ...
    String line = row1.line;

/*context.dataSourcePath = paramsRetriever.retrieveParams(line,"dataSourcePath");
context.dataOutputPath = paramsRetriever.retrieveParams(line,"dataOutputPath");
context.dictSourcePath = paramsRetriever.retrieveParams(line,"dictSourcePath");
context.dictOutputPath = paramsRetriever.retrieveParams(line,"dictOutputPath");
context.studyId = paramsRetriever.retrieveParams(line,"studyId");
context.studyName = paramsRetriever.retrieveParams(line,"studyName");
context.subjectTableId = paramsRetriever.retrieveParams(line,"subjectTableId");
context.subset = Boolean.parseBoolean(paramsRetriever.retrieveParams(line,"subset"));
context.number_to_keep = Integer.parseInt(paramsRetriever.retrieveParams(line,"number_to_keep"));
context.addVarName = Boolean.parseBoolean(paramsRetriever.retrieveParams(line,"addVarName"));
context.AgeInYearVarIdentifier = paramsRetriever.retrieveParams(line,"AgeInYearVarIdentifier");
context.GenderVarIdentifier = paramsRetriever.retrieveParams(line,"GenderVarIdentifier");
*/
if( line.startsWith("dataSourcePath")){
	context.dataSourcePath = line.split("=")[1];
	System.out.println("dataSourcePath ==> " + context.dataSourcePath);
}
if( line.startsWith("dataOutputPath")){
	context.dataOutputPath = line.split("=")[1];
	System.out.println("dataOutputPath ==> " + context.dataOutputPath);
}
if( line.startsWith("dictSourcePath")){
	context.dictSourcePath = line.split("=")[1];
	System.out.println("dictSourcePath ==> " + context.dictSourcePath);
}
if( line.startsWith("dictOutputPath")){
	context.dictOutputPath = line.split("=")[1];
	System.out.println("dictOutputPath ==> " + context.dictOutputPath);
}
if( line.startsWith("studyId")){
	context.studyId = line.split("=")[1];
	System.out.println("studyId ==> " + context.studyId);
}
if( line.startsWith("studyName")){
	context.studyName = line.split("=")[1];
	System.out.println("studyName ==> " + context.studyName);
}
if( line.startsWith("subjectTableId")){
	context.subjectTableId = line.split("=")[1];
	System.out.println("subjectTableId ==> " + context.subjectTableId);
}

if( line.startsWith("subset")){
	context.subset = Boolean.parseBoolean(line.split("=")[1].trim());
...
if( line.startsWith("AgeInYearVarIdentifier")){
	...
	if(line.split("=").length==2){
		...
		context.AgeInYearVarIdentifier = "";
	}
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tFileInputFullRow_1:OnSubjobOk1", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
							...
							tRunJob_2Process(globalMap); 
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tFileInputFullRow_1:OnSubjobOk2", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		obj_tRunJob_2 = context.dictOutputPath;
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param dictOutputPath=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param dictOutputPath=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("dictOutputPath", obj_tRunJob_2);
	
		obj_tRunJob_2 = context.dictSourcePath;
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param dictSourcePath=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param dictSourcePath=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("dictSourcePath", obj_tRunJob_2);
	
		obj_tRunJob_2 = context.studyName;
		if(obj_tRunJob_2!=null) {
			paraList_tRunJob_2.add("--context_param studyName=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_2));
		} else {
			paraList_tRunJob_2.add("--context_param studyName=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_2.put("studyName", obj_tRunJob_2);
	
	
		dbgap_aws.dbgapdictionnaryparser_0_1.dbgapDictionnaryParser childJob_tRunJob_2 = new dbgap_aws.dbgapdictionnaryparser_0_1.dbgapDictionnaryParser();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		obj_tRunJob_3 = context.dataSourcePath;
		if(obj_tRunJob_3!=null) {
			paraList_tRunJob_3.add("--context_param dataSourcePath=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		} else {
			paraList_tRunJob_3.add("--context_param dataSourcePath=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_3.put("dataSourcePath", obj_tRunJob_3);
	
		obj_tRunJob_3 = context.dataOutputPath;
		if(obj_tRunJob_3!=null) {
			paraList_tRunJob_3.add("--context_param dataOutputPath=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		} else {
			paraList_tRunJob_3.add("--context_param dataOutputPath=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_3.put("dataOutputPath", obj_tRunJob_3);
	
		obj_tRunJob_3 = context.studyId;
		if(obj_tRunJob_3!=null) {
			paraList_tRunJob_3.add("--context_param studyId=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		} else {
			paraList_tRunJob_3.add("--context_param studyId=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_3.put("studyId", obj_tRunJob_3);
	
		obj_tRunJob_3 = context.studyName;
		if(obj_tRunJob_3!=null) {
			paraList_tRunJob_3.add("--context_param studyName=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		} else {
			paraList_tRunJob_3.add("--context_param studyName=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_3.put("studyName", obj_tRunJob_3);
	
		obj_tRunJob_3 = context.subjectTableId;
		if(obj_tRunJob_3!=null) {
			paraList_tRunJob_3.add("--context_param subjectTableId=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		} else {
			paraList_tRunJob_3.add("--context_param subjectTableId=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_3.put("subjectTableId", obj_tRunJob_3);
	
		obj_tRunJob_3 = context.number_to_keep;
		if(obj_tRunJob_3!=null) {
			paraList_tRunJob_3.add("--context_param number_to_keep=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_3));
		} else {
			paraList_tRunJob_3.add("--context_param number_to_keep=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_3.put("number_to_keep", obj_tRunJob_3);
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    java.sql.Connection conn_tDBInput_1 = null;
			    ...
			    java.lang.Class.forName(driverClass_tDBInput_1);
					String dbUser_tDBInput_1 = context.dbUser;
					
					
					
	final String decryptedPassword_tDBInput_1 = context.dbPassword; 
					
					String dbPwd_tDBInput_1 = decryptedPassword_tDBInput_1;
				
			String url_tDBInput_1 = "jdbc:postgresql://" + context.dbHost + ":" + context.dbPort + "/" + context.dbName;
		    ...
		    String dbquery_tDBInput_1 = "SELECT COUNT (DISTINCT \""+context.dbName+"\".\"public\".\"dict\".\"varIdentifier\") as NB\nFROM \""+context.dbName+"\".\"public\".\"dict\" "
;
            ...
            row2.NB = rs_tDBInput_1.getInt(1);
...
fileWriter.writeLineToFile(context.dictOutputPath+"/StatsDict.txt", "Number of var :" + row2.NB, false);
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = context.dataSourcePath;
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param dataSourcePath=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param dataSourcePath=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("dataSourcePath", obj_tRunJob_1);
	
		obj_tRunJob_1 = context.dataOutputPath;
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param dataOutputPath=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param dataOutputPath=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("dataOutputPath", obj_tRunJob_1);
	
		obj_tRunJob_1 = context.studyId;
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param studyId=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param studyId=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("studyId", obj_tRunJob_1);
	
		obj_tRunJob_1 = context.studyName;
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param studyName=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param studyName=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("studyName", obj_tRunJob_1);
	
		obj_tRunJob_1 = context.subjectTableId;
		if(obj_tRunJob_1!=null) {
			paraList_tRunJob_1.add("--context_param subjectTableId=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
		} else {
			paraList_tRunJob_1.add("--context_param subjectTableId=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("subjectTableId", obj_tRunJob_1);
	
	
		dbgap_aws.mapper_filemanager_0_2.Mapper_FileManager childJob_tRunJob_1 = new dbgap_aws.mapper_filemanager_0_2.Mapper_FileManager();
	    // pass DataSources
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tJava_1";
		...
		int tos_count_tJava_1 = 0;
			  ...
			  writeConfigFile4EntityGenerator.writeConfig(context.dataOutputPath+"CONFIGURATION/", context.studyName+".config", context.dataOutputPath, context.studyName);
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = mainJob.class.getClassLoader().getResourceAsStream("dbgap_aws/mainjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = mainJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            ...
            class ContextProcessing {
                private void processContext_0() {
                        context.setContextType("configFilePath", "id_String");
                            context.configFilePath=(String) context.getProperty("configFilePath");
                        context.setContextType("dataOutputPath", "id_String");
                            context.dataOutputPath=(String) context.getProperty("dataOutputPath");
                        context.setContextType("dataSourcePath", "id_String");
                            context.dataSourcePath=(String) context.getProperty("dataSourcePath");
                        context.setContextType("dictOutputPath", "id_String");
                        ...
                        context.setContextType("dbPassword", "id_Password");
                            ...
                            if(pwd_dbPassword_value!=null) {
                                if(context_param.containsKey("dbPassword")) {//no need to decrypt if it come from program argument or parent job runtime
                                    context.dbPassword = pwd_dbPassword_value;
                                } else if (!pwd_dbPassword_value.isEmpty()) {
                                    try {
                                        context.dbPassword = routines.system.PasswordEncryptUtil.decryptPassword(pwd_dbPassword_value);
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("configFilePath")) {
                context.configFilePath = (String) parentContextMap.get("configFilePath");
            }if (parentContextMap.containsKey("dataOutputPath")) {
                context.dataOutputPath = (String) parentContextMap.get("dataOutputPath");
            }if (parentContextMap.containsKey("dataSourcePath")) {
                context.dataSourcePath = (String) parentContextMap.get("dataSourcePath");
            }if (parentContextMap.containsKey("dictOutputPath")) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : mainJob");
        }
...
/************************************************************************************************
 *     102747 characters generated by Talend Open Studio for Data Integration 
 *     on the 8 mai 2019 18:00:27 EDT
 ************************************************************************************************/